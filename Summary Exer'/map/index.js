...
const toStr2 = floatNumbers.map((el)=>{
...
const x = myMap(floatNumbers, consoleLog);
console.log(x);
...
const movies2 =[
    {name:"Free Willy" , id:1},
    {name:"Terminator" , id:2}
]
const names = movies.map((movie) =>{
    return movie.name;
});
const names2 = movies2.map((movie) =>{
    return movie.name;
})
